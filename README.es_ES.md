...
Descargue `docker-manager-go-linux-<arch>.tar.gz` desde la [página de Releases](https://github.com/DockerManger/Docker_Manager_Go/releases/latest), extráigalo y ejecute:
