...
- **Магазин приложений** — 260+ приложений в один клик (репозиторий, совместимый с 1Panel: иконки / формы параметров / несколько версий); синхронизация с GitHub, установка / обновление в один клик со значком доступного обновления.
