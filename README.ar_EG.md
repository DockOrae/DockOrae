...
- **إدارة الحاويات** — إنشاء / تشغيل / إيقاف / إعادة تشغيل / إيقاف مؤقت / حذف / فحص / إرفاق، مع **طرفية ويب** مدمجة.
...
- **إدارة وحدات التخزين** — إنشاء / حذف / فحص.
...
- **الطرفية** — طرفية المضيف (chroot `/host`)، وطرفية الحاوية، و**إدارة مضيفات SSH** (مجموعات / اتصال / مصادقة بكلمة مرور ومفتاح)، وأوامر سريعة، وإعدادات مظهر الطرفية.
