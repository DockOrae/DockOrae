...
- **متجر التطبيقات** — أكثر من 260 تطبيقًا بنقرة واحدة (مستودع متوافق مع 1Panel: أيقونات / نماذج معلمات / إصدارات متعددة)؛ مزامنة تلقائية عند أول تشغيل (بدون خطوة يدوية)، تثبيت / ترقية بنقرة واحدة مع شارة التحديث المتاح.
...
نزّل `docker-manager-go-linux-<arch>.tar.gz` من [صفحة الإصدارات](https://github.com/DockerManger/Docker_Manager_Go/releases/latest)، ثم فك ضغطه وشغّله:
