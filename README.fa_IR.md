...
- **مدیریت کانتینرها** — ایجاد / شروع / توقف / راه‌اندازی مجدد / مکث / حذف / بازرسی / اتصال، همراه با **ترمینال وب** داخلی.
...
- **مدیریت حجم‌ها** — ایجاد / حذف / بازرسی.
...
- **ترمینال** — ترمینال میزبان (chroot `/host`)، ترمینال کانتینر و **مدیریت میزبان‌های SSH** (گروه‌ها / اتصال / احراز هویت با رمز عبور و کلید)، دستورات سریع، تنظیمات ظاهر ترمینال.
...
فایل `docker-manager-go-linux-<arch>.tar.gz` را از [صفحه Releases](https://github.com/MinimaxFlora/Docker_Manager_Go/releases/latest) دانلود کنید، آن را استخراج کنید و اجرا کنید:
