...
فایل `docker-manager-go-linux-<arch>.tar.gz` را از [صفحه Releases](https://github.com/DockerManger/Docker_Manager_Go/releases/latest) دانلود کنید، آن را استخراج کنید و اجرا کنید:
